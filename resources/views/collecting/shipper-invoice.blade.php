        ...
        <div class="info-row">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($collection->status === 'completed')
                                <span style="color: #15803d;">✅ تم الاعتماد</span>
            ...
            <div class="info-card">
                ...
                <table>
                    <tr>
                        <td>الاسم:</td>
                        <td>{{ $collection->shipper->name }}</td>
                    </tr>
                    <tr>
                        <td>الهاتف:</td>
                        <td dir="ltr">{{ $collection->shipper->phone ?? '-' }}</td>
                    </tr>
                    <tr>
                        <td>عدد الطلبات:</td>
            ...
            <tbody>
                @foreach($collection->orders as $index => $order)
                    <tr>
                        ...
                        <td>
                            @if($order->has_return)
                                <span class="return-yes">نعم</span>
                            @else
                                <span class="return-no">لا</span>
                            @endif
                        </td>
        ...
        <div class="summary-row">
            <div class="summary-box">
                <table>
                    ...
                    <tr>
                        <td>إجمالي عمولة المندوب:</td>
                        <td>{{ number_format($collection->shipper_fees, 2) }} ج.م</td>
                    </tr>
                    <tr>
                        <td>الصافي المستلم من المندوب:</td>
