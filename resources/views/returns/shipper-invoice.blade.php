...
<head>
    ...
    <title>فاتورة مرتجع مندوب #{{ $record->id }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="invoice">
        ...
        <div class="info-row">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($record->status === 'completed')
                                <span style="color: #15803d;">✅ تم الاستلام</span>
            ...
            <div class="info-card">
                ...
                <table>
                    <tr>
                        <td>الاسم:</td>
                        <td>{{ $record->shipper->name }}</td>
                    </tr>
                    <tr>
                        <td>الهاتف:</td>
                        <td dir="ltr">{{ $record->shipper->phone ?? '-' }}</td>
                    </tr>
                    <tr>
                        <td>عدد الطلبات المرتجعة:</td>
        ...
        <!-- Orders Table -->
        <h3 class="orders-title">📦 قائمة الأوردرات المرتجعة</h3>
        ...
        <div class="summary-row">
            <div class="summary-box">
                <table>
                    ...
                    <tr>
                        <td colspan="2" style="background: #fb2c36; color: white; text-align: center;">إقرار باستلام المرتجعات المذكورة</td>
                    </tr>
                </table>
            </div>
        </div>
