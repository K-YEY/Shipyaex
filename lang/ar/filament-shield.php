    ...
    */
    ...
    'resource' => [
        'label' => [
            ...
            'setting' => 'إعدادات',
            'shipping_content' => 'محتويات الشحن',
            'order_status' => 'حالة الطلب',
            'refused_reason' => 'سبب الرفض',
            'collected_client' => 'تحصيل عميل',
            'collected_shipper' => 'تحصيل مندوب',
            'returned_client' => 'مرتجع عميل',
            'returned_shipper' => 'مرتجع مندوب',
            'governorate' => 'محافظة',
            'city' => 'مدينة',
            'expense' => 'مصروف',
        ],
    ...
    'resource_permission_prefixes_labels' => [
        ...
        'assign_shipper' => 'إسناد مندوب',
        'return_shipper' => 'تسجيل مرتجع مندوب',
        'return_client' => 'تسجيل مرتجع عميل',
        'clear_list' => 'مسح القائمة',
        'remove_order' => 'إزالة طلب من القائمة',
        'view_widget' => 'عرض الإحصائية/الودجيت',
        'bypass_working_hours' => 'تخطي ساعات العمل',
        'barcode_scanner_action' => 'إجراء ماسح الباركود',
        ...
        'view_name_column' => 'عرض عمود الاسم',
        ...
        'view_follow_up_hours_column' => 'عرض عمود ساعات المتابعة',
        'view_governorate_column' => 'عرض عمود المحافظة',
        'view_city_column' => 'عرض عمود المدينة',
        'view_order_statuses_column' => 'عرض عمود حالات الطلب',
        'view_color_column' => 'عرض عمود اللون',
        'view_sort_order_column' => 'عرض عمود الترتيب',
        'view_active_column' => 'عرض عمود التفعيل',
        'view_clear_reasons_column' => 'عرض عمود أسباب الإلغاء',
        'view_refused_reasons_column' => 'عرض عمود أسباب الرفض',
        'view_slug_column' => 'عرض عمود الاسم اللطيف (Slug)',
        'view_collection_date_column' => 'عرض عمود تاريخ التحصيل',
        'view_return_date_column' => 'عرض عمود تاريخ المرتجع',
        ...
        'view_cop_field' => 'عرض حقل حصة الشركة (COP)',
        'edit_cop_field' => 'تعديل حقل حصة الشركة (COP)',
        'edit_name_field' => 'تعديل حقل الاسم',
        'edit_follow_up_hours_field' => 'تعديل حقل ساعات المتابعة',
        'edit_shipper_field' => 'تعديل حقل المندوب',
        'edit_governorate_field' => 'تعديل حقل المحافظة',
        'edit_color_field' => 'تعديل حقل اللون',
        'edit_sort_order_field' => 'تعديل حقل الترتيب',
        'edit_active_field' => 'تعديل حقل التفعيل',
        'edit_clear_reasons_field' => 'تعديل حقل أسباب الإلغاء',
        'edit_refused_reasons_field' => 'تعديل حقل أسباب الرفض',
        'edit_collection_date_field' => 'تعديل حقل تاريخ التحصيل',
        'edit_return_date_field' => 'تعديل حقل تاريخ المرتجع',
        'edit_status_field' => 'تعديل حقل الحالة',
        ...
        'view_summary_field' => 'عرض حقل الملخص',
        'view_orders_count_field' => 'عرض حقل عدد الطلبات',
        'view_total_amount_field' => 'عرض حقل إجمالي المبلغ',
        'view_fees_field' => 'عرض حقل الرسوم',
        'view_net_amount_field' => 'عرض حقل صافي المبلغ',
        'view_notes_field' => 'عرض حقل الملاحظات',
        'edit_notes_field' => 'تعديل حقل الملاحظات',
        'view_selected_orders_field' => 'عرض حقل الطلبات المختارة',
        'edit_selected_orders_field' => 'تعديل حقل الطلبات المختارة',
