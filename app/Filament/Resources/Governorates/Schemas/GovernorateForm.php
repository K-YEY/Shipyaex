        ...
        return $schema
            ->components([
               ...
               Select::make('shipper_id')
                    ...
                    ->disabled(fn () => !auth()->user()->can('EditShipperField:Governorate'))
                    ->relationship(
                        name: 'shipper',
                        titleAttribute: 'name',
